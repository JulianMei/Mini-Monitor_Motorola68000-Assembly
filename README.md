...
The monitor program includes 4 parts: _**1. User command interpreter 2. User command handling subroutines 3. Exception handling subroutines 4. Utility subroutines**_. The execution flow is described in the digram below: <br />
